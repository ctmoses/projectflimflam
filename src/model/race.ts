...
export class dwarf implements IRace {
    ...
    constructor(){
        ...
        this.power = new spell(AbilityRefresh.BATTLE, AbilityTrigger.DAMAGETAKEN, AbilityType.FREE, 0,"That’s Your Best Shot? ", text);
    }
}
export class darkelf implements IRace {
    ...
    constructor(){
        ...
        this.power = new spell(AbilityRefresh.BATTLE, AbilityTrigger.HIT, AbilityType.FREE,0,"Cruel", text);
    }
}
...
export class halfelf implements IRace {
    ...
    constructor(){
        ...
        this.power = new spell(AbilityRefresh.BATTLE, AbilityTrigger.NONE, AbilityType.FREE, 0,"Surprising", text);
    }
}
export class halforc implements IRace {
    ...
    constructor(){
        ...
        this.power = new spell(AbilityRefresh.BATTLE, AbilityTrigger.NONE, AbilityType.FREE,0, "Lethal", text);
    }
}
export class halfling implements IRace {
    ...
    constructor(){
        ...
        this.power = new spell(AbilityRefresh.BATTLE, AbilityTrigger.DAMAGETAKEN, AbilityType.FREE, 0,"Evasive", text);
...
export class highelf implements IRace {
    ...
    constructor(){
        ...
        this.power = new spell(AbilityRefresh.BATTLE, AbilityTrigger.NONE, AbilityType.MOVE, 0, "Highblood Teleport", text);
    }
}
export class human implements IRace {
    ...
    constructor(){
        ...
        this.power = new spell(AbilityRefresh.BATTLE, AbilityTrigger.NONE, AbilityType.FREE,0, "Quick to Fight", text);
    }
}
export class woodelf implements IRace {
    ...
    constructor(){
        ...
        this.power = new spell(AbilityRefresh.BATTLE, AbilityTrigger.NONE, AbilityType.FREE, 0,"Elven Grace", text);
    }
}